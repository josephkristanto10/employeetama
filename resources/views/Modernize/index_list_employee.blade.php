              ...
              <div class="card-body">
                <div class="d-sm-flex d-block align-items-center justify-content-between mb-9">
                  <div class="mb-3 mb-sm-0">
                    <h5 class="card-title fw-semibold">List Employee</h5>
                  </div>
                  {{-- <div>
                ...
                <table class="table table-bordered table-hover w-100" id = "table_list_employee">
                  <thead>
                  <tr>
                    <th>No</th>
                    <th>Name</th>
                    <th>City & Birth Date</th>
                    <th>Address</th>
                    <th>Phone</th>
                    <th>Join Date</th>
                    <th>Work Duration</th>
...
<script>
  ...
  $(document).ready(function () {
    $('#table_list_employee').DataTable({
      processing: true,
      serverSide: true,
      ajax: '{{route('daftar_employee')}}',
      order : [[ 5, "asc" ]],
      columns: [
        {
