              ...
              <div class="card-body">
                <div class="d-sm-flex d-block align-items-center justify-content-between mb-9">
                  <div class="mb-3 mb-sm-0">
                    ...
                    <h5 class="card-title fw-semibold">Add Bonus Panen Hidup </h5>
                  </div>
                ...
                <div class="mb-3 mb-sm-0">
                  <h5 class="card-title fw-semibold">Bonus Panen Hidup</h5>
                </div>
                {{-- <div id="chart"></div> --}}
 ...
 var id_bonus_panen = 0;
  ...
  $(document).ready(function () {
    ...
    $('#table_bonus_panen').DataTable({
      ...
      serverSide: true,
      ajax: {
        url: '{{route('listbonuspanen_hidup')}}',
        data : {
  ...
  function addbonuspanen(e){
    ...
    var formData = $('#add_bonus_panen').serializeArray();
    formData.push({ name: "id_master_month", value:  id_bonus_panen});

    $.ajax({
    type: "post",
    url: "{{ route('addbonuspanen_live') }}",
    data: formData,
    dataType: "json",
    success: function (response) {
           Swal.fire(
  ...
  function lihatdetail(myid){
    ...
    $('#table_bonus_detail_panen').DataTable({
      ...
      serverSide: true,
      ajax: {
        url: '{{route('listdetailbonuspanen_hidup')}}',
        data : {
  ...
  function add_master_bonus_panen(e){
    ...
    $.ajax({
    type: "post",
    url: "{{ route('addmasterbonuspanen') }}",
    data: $('#addbonuspanen').serialize(),
    dataType: "json",
    success: function (response) {
           Swal.fire(
             'Data Created',
              "Bonus Panen Hidup Successfuly",
              'success'
            );
